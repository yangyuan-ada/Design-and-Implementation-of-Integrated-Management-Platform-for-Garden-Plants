...
public class AchieveService {
	...
	public static void leaderMenu(String userid) {
		...
		System.out.println("查询研究生通过终审成果认定情况");
		...
		while(true) {
			...
			if(c.contentEquals("A")) {
				...
				while(true) {
					...
					if(choice.contentEquals("1")) {
						System.out.println("请输入您想申请的论文认证个数：");
						...
						for(int j=0;j<count;j++) {
							Thesis t=new Thesis();
							System.out.println("论文名称：");
							t.setName(scanner.nextLine());
							System.out.println("论文发表刊物名称：");
							t.setPubname(scanner.nextLine());
							System.out.println("论文发表时间：yyyy-MM-dd");
							...
							t.setPubtime(tmp);
							System.out.println("论文发表状态：(录用未发表/已发表)");
							tmp=scanner.nextLine();
							...
							t.setPubstate(tmp);
							System.out.println("论文索引类型：");
							t.setIndextype(scanner.nextLine());
							System.out.println("论文归属库情况：(学院高质量论文库/学院核心论文库)");
							tmp=scanner.nextLine();
					...
					if(choice.contentEquals("2")) {
						System.out.println("请输入您想申请的奖励认证个数：");
						while (!scanner.hasNextInt()){
						    System.out.println("请输入整数！");
						}
						int count=scanner.nextInt();
						...
						for(int j=0;j<count;j++) {
							...
							t.setName(scanner.nextLine());
							System.out.println("奖励等级：(国家级/省部级/市级/其他)");
							String tmp=scanner.nextLine();
							...
							t.setRelevel(tmp);
							System.out.println("获奖等级：(特等奖/一等奖/二等奖/三等奖)");
							tmp=scanner.nextLine();
							...
							t.setRank(scanner.nextLine());
							System.out.println("获奖时间：yyyy-MM-dd");
							tmp=scanner.nextLine();
							while(!isValidDate(tmp)) {
								System.out.println("请以yyyy-MM-dd格式输入时间！");
								tmp=scanner.nextLine();
					...
					if(choice.contentEquals("3")) {
						System.out.println("请输入您想申请的标准认证个数：");
						while (!scanner.hasNextInt()){
						    System.out.println("请输入整数！");
						}
						int count=scanner.nextInt();
						...
						for(j=0;j<count;j++) {
							...
							System.out.println("标准名称：");
							t.setName(scanner.nextLine());
							System.out.println("标准等级：(国家标准/省部级地方标准/行业标准/团队标准)");
							String tmp=scanner.nextLine();
							...
							t.setGetlevel(tmp);
							System.out.println("标准发布时间：yyyy-MM-dd");
							tmp=scanner.nextLine();
							while(!isValidDate(tmp)) {
								System.out.println("请以yyyy-MM-dd格式输入时间！");
								tmp=scanner.nextLine();
					...
					if(choice.contentEquals("4")) {
						System.out.println("请输入您想申请的报告认证个数：");
						while (!scanner.hasNextInt()){
							System.out.println("请输入整数！");
						}
						int count=scanner.nextInt();
						...
						for(j=0;j<count;j++) {
							...
							System.out.println("报告时间：yyyy-MM-dd");
							String tmp=scanner.nextLine();
							while(!isValidDate(tmp)) {
								System.out.println("请以yyyy-MM-dd格式输入时间！");
								tmp=scanner.nextLine();
							...
							t.setTime(tmp);
							System.out.println("报告类型：(规划类/设计类/服务类/其他)");
							tmp=scanner.nextLine();
							...
							t.setType(tmp);
							System.out.println("贡献度排名（整数）：");
							t.setContribution(scanner.nextInt());
							scanner.nextLine();
							System.out.println("佐证材料：");
							t.setMaterial(scanner.nextLine());
							t.setSid(userid);
					...
					if(choice.contentEquals("5")) {
						System.out.println("请输入您想申请的专利认证个数：");
						...
						for(j=0;j<count;j++) {
							Patent t=new Patent();
							System.out.println("专利名称：");			//输入专利名称
							t.setName(scanner.nextLine());
							System.out.println("专利号：");			//输入专利号
							t.setId(scanner.nextLine());
							System.out.println("专利发布时间：yyyy-MM-dd");		//输入专利发布时间
							String tmp=scanner.nextLine();
							while(!isValidDate(tmp)) {
								System.out.println("请以yyyy-MM-dd格式输入时间！");
								tmp=scanner.nextLine();
							...
							t.setTime(tmp);
							System.out.println("专利类型(发明专利/实用新型专利)：");		//限制专利类型
							tmp=scanner.nextLine();
							...
							t.setType(tmp);
							System.out.println("贡献度排名（整数）：");		//输入贡献度排名
							t.setContribution(scanner.nextInt());
							scanner.nextLine();
							System.out.println("专利状态：");		//输入专利状态
							t.setStatus(scanner.nextLine());
							System.out.println("佐证材料：");		//输入佐证材料
							t.setMaterial(scanner.nextLine());
							t.setSid(userid);
					...
					if(choice.contentEquals("6")) {
						System.out.println("请输入您想申请的软硬件平台认证个数：");
						while (!scanner.hasNextInt()){
							System.out.println("请输入整数！");
						}
						int count=scanner.nextInt();
						...
						for(j=0;j<count;j++) {
							...
							t.setAddress(scanner.nextLine());
							System.out.println("平台上线时间：yyyy-MM-dd");
							String tmp=scanner.nextLine();
							while(!isValidDate(tmp)) {
								System.out.println("请以yyyy-MM-dd格式输入时间！");
								tmp=scanner.nextLine();
					...
					if(choice.contentEquals("7")) {
						System.out.println("请输入您想申请的教材认证个数：");
						while (!scanner.hasNextInt()){
							System.out.println("请输入整数！");
						}
						int count=scanner.nextInt();
						...
						for(j=0;j<count;j++) {
							...
							t.setName(scanner.nextLine());
							System.out.println("教材出版社：");
							t.setPress(scanner.nextLine());
							System.out.println("教材出版时间：yyyy-MM-dd");
							String tmp=scanner.nextLine();
							while(!isValidDate(tmp)) {
								System.out.println("请以yyyy-MM-dd格式输入时间！");
								tmp=scanner.nextLine();
			...
			if(c.contentEquals("C")) {
				...
				while(true) {
					...
					choice = scanner.nextLine();//程序会等待用户输入完毕
					while(!choice.contentEquals("1")&&!choice.contentEquals("2")&&!choice.contentEquals("3")&&!choice.contentEquals("4")&&!choice.contentEquals("5")&&!choice.contentEquals("6")&&!choice.contentEquals("7")&&!choice.contentEquals("0")) {
						System.out.println("您的输入不正确，请重新输入：");
							...
							if(lt.get(k).getState().contentEquals("3")||lt.get(k).getState().contentEquals("4")) {
								...
								if(inchoice.contentEquals("1")) {
									...
									while(true) {
										...
										String inc="";
										inc = scanner.nextLine();//程序会等待用户输入完毕
										while(!inc.contentEquals("1")&&!inc.contentEquals("2")&&!inc.contentEquals("3")&&!inc.contentEquals("4")&&!inc.contentEquals("5")&&!inc.contentEquals("6")&&!inc.contentEquals("7")&&!inc.contentEquals("0")) {
											System.out.println("您的输入不正确，请重新输入：");
											inc = scanner.nextLine();
										}
										if(inc.contentEquals("0")) {
											break;
										}
										if(inc.contentEquals("1")) {
											System.out.println("论文名称：");
											t.setName(scanner.nextLine());
										}
										if(inc.contentEquals("2")) {
											System.out.println("论文发表刊物名称：");
											t.setPubname(scanner.nextLine());
										}
										if(inc.contentEquals("3")) {
											System.out.println("论文发表时间：yyyy-MM-dd");
											String tmp=scanner.nextLine();
											while(!isValidDate(tmp)) {
												System.out.println("请以yyyy-MM-dd格式输入时间！");
										...
										if(inc.contentEquals("5")) {
											System.out.println("论文索引类型：");
											t.setIndextype(scanner.nextLine());
										}
										if(inc.contentEquals("6")) {
											System.out.println("论文归属库情况：(学院高质量论文库/学院核心论文库)");
											String tmp=scanner.nextLine();
											while(!tmp.contentEquals("学院高质量论文库")&&!tmp.contentEquals("学院核心论文库")) {
												System.out.println("请输入学院高质量论文库/学院核心论文库！");
							...
							if(lt.get(k).getStatus().contentEquals("初审结果：拒绝")||lt.get(k).getStatus().contentEquals("终审结果：拒绝")) {
								...
								if(inchoice.contentEquals("1")) {
									...
									while(true) {
										...
										String inc = scanner.nextLine();//程序会等待用户输入完毕
										while(!inc.contentEquals("1")&&!inc.contentEquals("2")&&!inc.contentEquals("3")&&!inc.contentEquals("4")&&!inc.contentEquals("5")&&!inc.contentEquals("6")&&!inc.contentEquals("0")) {
											System.out.println("您的输入不正确，请重新输入：");
											inc = scanner.nextLine();
										}
							...
							if(lt.get(k).getTstatus().contentEquals("初审结果：拒绝")||lt.get(k).getTstatus().contentEquals("终审结果：拒绝")) {			//状态位为被打回
								...
								if(inchoice.contentEquals("1")) {
									...
									while(true) {
										...
										if(inc.contentEquals("1")) {				//对专利名称进行修改
											System.out.println("专利名称：");
											t.setName(scanner.nextLine());
										}
										if(inc.contentEquals("2")) {
											System.out.println("专利类型：(发明专利/实用新型专利)");		//对专利类型进行修改
											String tmp=scanner.nextLine();
										...
										if(inc.contentEquals("3")) {				//对专利时间进行修改
											System.out.println("专利发布时间：yyyy-MM-dd");
											String tmp=scanner.nextLine();
										...
										if(inc.contentEquals("4")) {				//对专利状态进行修改
											System.out.println("专利状态：");
											t.setStatus(scanner.nextLine());
										}
										if(inc.contentEquals("5")) {				//对贡献度排名进行修改
											System.out.println("贡献度排名（整数）：");
											t.setContribution(Integer.parseInt(scanner.nextLine()));
										}
										if(inc.contentEquals("6")) {				//对佐证材料进行修改
											System.out.println("佐证材料：");
											t.setMaterial(scanner.nextLine());
										}
									}
									t.setTstatus("未审核");									//将审核状态改为未审核，从初审开始
			...
			if(c.contentEquals("D")) {
				...
				System.out.println("请输入您想撤回的论文认证个数：");
				while (!scanner.hasNextInt()){
				    System.out.println("请输入整数！");
				}
				int count=scanner.nextInt();
				while(count>lt.size()||count<0) {
					System.out.println("请输入0-"+lt.size()+"的数字！");
					while (!scanner.hasNextInt()){
					    System.out.println("请输入整数！");
					}
				...
				int j=0;
				for(j=0;j<count;j++) {
					System.out.println("请输入您想撤回的论文序号：");
					while (!scanner.hasNextInt()){
					    System.out.println("请输入整数！");
					}
					int index=scanner.nextInt();
					while(index>lt.size()||index<1) {
						System.out.println("请输入1-"+lt.size()+"的数字！");
						while (!scanner.hasNextInt()){
						    System.out.println("请输入整数！");
						}
				...
				System.out.println("请输入您想撤回的奖励认证个数：");
				while (!scanner.hasNextInt()){
				    System.out.println("请输入整数！");
				}
				count=scanner.nextInt();
				while(count>lt2.size()||count<0) {
					System.out.println("请输入0-"+lt2.size()+"的数字！");
					while (!scanner.hasNextInt()){
					    System.out.println("请输入整数！");
					}
					count=scanner.nextInt();
				...
				j=0;
				for(j=0;j<count;j++) {
					System.out.println("请输入您想撤回的奖励序号：");
					while (!scanner.hasNextInt()){
					    System.out.println("请输入整数！");
					}
					int index=scanner.nextInt();
					while(index>lt2.size()||index<1) {
						System.out.println("请输入1-"+lt2.size()+"的数字！");
						while (!scanner.hasNextInt()){
						    System.out.println("请输入整数！");
						}
						index=scanner.nextInt();
				...
				System.out.println("请输入您想撤回的标准认证个数：");
				while (!scanner.hasNextInt()){
				    System.out.println("请输入整数！");
				}
				count=scanner.nextInt();
				while(count>lt3.size()||count<0) {
					System.out.println("请输入0-"+lt3.size()+"的数字！");
					while (!scanner.hasNextInt()){
					    System.out.println("请输入整数！");
					}
					count=scanner.nextInt();
				...
				j=0;
				for(j=0;j<count;j++) {
					System.out.println("请输入您想撤回的标准序号：");
					while (!scanner.hasNextInt()){
					    System.out.println("请输入整数！");
					}
					int index=scanner.nextInt();
					while(index>lt.size()||index<1) {
						System.out.println("请输入1-"+lt3.size()+"的数字！");
						while (!scanner.hasNextInt()){
						    System.out.println("请输入整数！");
						}
						index=scanner.nextInt();
				...
				System.out.println("请输入您想撤回的报告认证个数：");
				while (!scanner.hasNextInt()){
					System.out.println("请输入整数！");
				}
				count=scanner.nextInt();
				while(count>lt4.size()||count<0) {
					System.out.println("请输入0-"+lt4.size()+"的数字！");
					while (!scanner.hasNextInt()){
						System.out.println("请输入整数！");
					}
					count=scanner.nextInt();
				...
				j=0;
				for(j=0;j<count;j++) {
					System.out.println("请输入您想撤回的报告序号：");
					while (!scanner.hasNextInt()){
						System.out.println("请输入整数！");
					}
					int index=scanner.nextInt();
					while(index>lt4.size()||index<1) {
						System.out.println("请输入1-"+lt4.size()+"的数字！");
						while (!scanner.hasNextInt()){
							System.out.println("请输入整数！");
						}
						index=scanner.nextInt();
				...
				System.out.println("请输入您想撤回的专利认证个数：");
				while (!scanner.hasNextInt()){					//对输入进行控制
					System.out.println("请输入整数！");
				}
				count=scanner.nextInt();
				while(count>lt5.size()||count<0) {
					System.out.println("请输入0-"+lt5.size()+"的数字！");	 //对输入进行控制
					while (!scanner.hasNextInt()){
						System.out.println("请输入整数！");
					}
					count=scanner.nextInt();
				...
				j=0;
				for(j=0;j<count;j++) {
					System.out.println("请输入您想撤回的专利序号：");			//对输入进行控制
					while (!scanner.hasNextInt()){
						System.out.println("请输入整数！");
					}
					int index=scanner.nextInt();
					while(index>lt5.size()||index<1) {
						System.out.println("请输入1-"+lt5.size()+"的数字！");	//对输入进行控制
						while (!scanner.hasNextInt()){
							System.out.println("请输入整数！");
						}
						index=scanner.nextInt();
				...
				System.out.println("请输入您想撤回的软硬件平台认证个数：");
				while (!scanner.hasNextInt()){
					System.out.println("请输入整数！");
				}
				count=scanner.nextInt();
				while(count>lt6.size()||count<0) {
					System.out.println("请输入0-"+lt6.size()+"的数字！");
					while (!scanner.hasNextInt()){
						System.out.println("请输入整数！");
					}
					count=scanner.nextInt();
				...
				j=0;
				for(j=0;j<count;j++) {
					System.out.println("请输入您想撤回的软硬件平台认证序号：");
					while (!scanner.hasNextInt()){
						System.out.println("请输入整数！");
					}
					int index=scanner.nextInt();
					while(index>lt6.size()||index<1) {
						System.out.println("请输入1-"+lt6.size()+"的数字！");
						while (!scanner.hasNextInt()){
							System.out.println("请输入整数！");
						}
						index=scanner.nextInt();
				...
				System.out.println("请输入您想撤回的教材认证个数：");
				while (!scanner.hasNextInt()){
					System.out.println("请输入整数！");
				}
				count=scanner.nextInt();
				while(count>lt7.size()||count<0) {
					System.out.println("请输入0-"+lt7.size()+"的数字！");
					while (!scanner.hasNextInt()){
						System.out.println("请输入整数！");
					}
					count=scanner.nextInt();
				...
				j=0;
				for(j=0;j<count;j++) {
					System.out.println("请输入您想撤回的教材序号：");
					while (!scanner.hasNextInt()){
						System.out.println("请输入整数！");
					}
					int index=scanner.nextInt();
					while(index>lt7.size()||index<1) {
						System.out.println("请输入1-"+lt7.size()+"的数字！");
						while (!scanner.hasNextInt()){
							System.out.println("请输入整数！");
						}
						index=scanner.nextInt();
